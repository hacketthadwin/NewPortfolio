...
import Particles from "./othercomps/Particles.jsx"
...
const Home = () => {
  ...
  return (
    <MotionWrapper>
      {/* Added border-5 border-white rounded-2xl to the main container */}
      <div
        style={{
          position: "relative",
          minHeight: "100vh",
          ...
          boxSizing: "border-box", // Ensures border is included in the element's dimensions
          margin: "1rem", // Added margin to ensure the border is visible
        }}
        className="overflow-x-hidden overflow-y-hidden rounded-2xl border-[0.05rem] lg:border-[0.1rem] border-[#323332] absolute top-[-2rem] md:top-0 scale-110 sm:scale-105"
      >
        <div>
          <ResponsiveParticles/>
          ...
          <div className="relative group">
            <img
              ...
              alt="myimage"
              className="w-[8rem] sm:w-[11rem] md:w-[13rem] lg:w-[20rem] xl:w-[27rem] 2xl:w-[30rem] ml-[-4rem] sm:ml-[-3rem] md:ml-[-2rem] lg:ml-[-2rem] xl:ml-[-5rem] 2xl:ml-[-10rem] grayscale hover:grayscale-0 mt-[-1rem] sm:mt-[0rem] md:mt-[5rem] lg:mt-[5rem] xl:mt-[6rem] 2xl:mt-[4rem]
            ...
            />
            <Magnet
              wrapperClassName="absolute top-[-9rem] sm:top-[-12rem] md:top-[-16rem] lg:top-[-17rem] xl:top-[-27rem] 2xl:top-[-29rem] left-[8rem] sm:left-[15rem] md:left-[20rem] lg:left-[40rem] xl:left-[52rem] 2xl:left-[50rem] flex items-center justify-center w-[10rem] sm:w-[20rem] md:w-[30rem] lg:w-[50rem] xl:w-[50rem] 2xl:w-[50rem] h-[10rem] sm:h-[20rem] md:h-[30rem] lg:h-[40rem] xl:h-[50rem] 2xl:h-[50rem] z-[200]"
            ...
            >
              <a
                href="https://drive.google.com/file/d/1Sv_YAWhfAX1tPbnnTHgKvnKXagpALEYV/view?usp=sharing"
        ...
        <ScrollReveal
          ...
          containerClassName="w-screen mt-[-8rem] sm:mt-[-20rem] md:mt-[-28rem] lg:mt-[-30rem] xl:mt-[-25rem] 2xl:mt-[-40rem] ml-[-5.7rem] sm:ml-[-7.7rem] md:ml-[-8rem] lg:ml-[-9rem] xl:ml-[-11rem] 2xl:ml-[-5rem] p-[1rem] sm:p-[3rem] md:p-[4rem] lg:p-[5rem] xl:p-[6rem] 2xl:p-[8rem]"
        >
          Hi, My Name is
        </ScrollReveal>
        <ScrollReveal
          ...
          containerClassName="w-screen mt-[-5.25rem] sm:mt-[-11.4rem] md:mt-[-14.9rem] lg:mt-[-19.4rem] xl:mt-[-19.1rem] 2xl:mt-[-23.3rem] ml-[2rem] sm:ml-[9.8rem] md:ml-[15.2rem] lg:ml-[25rem] xl:ml-[14rem] 2xl:ml-[20rem] p-[1rem] sm:p-[3rem] md:p-[4rem] lg:p-[5rem] xl:p-[6rem] 2xl:p-[8rem]"
        >
          Adarsh Jha,
        </ScrollReveal>
        <ScrollReveal
        ...
        <RotatingText
          ...
          auto={true}
          splitBy="characters"
          mainClassName="text-[0.5rem] sm:text-[0.8rem] md:text-[0.8rem] lg:text-[1.1rem] xl:text-[1.7rem] 2xl:text-[2.5rem] font-bold text-white mt-[-1.5rem] sm:mt-[-2.0rem] md:mt-[-2.4rem] lg:mt-[-2.8rem] xl:mt-[-3.7rem] 2xl:mt-[-4.7rem] ml-[-2.9rem] sm:ml-[-2.0rem] md:ml-[-1rem] lg:ml-[1rem] xl:ml-[2rem] 2xl:ml-[3rem]"
        />

        <div className="font-bold text-gray-300 text-md sm:text-lg md:text-xl lg:text-3xl xl:text-4xl 2xl:text-5xl mt-[1rem] sm:mt-[-2em] md:mt-[-3.5rem] lg:mt-[-5rem] xl:mt-[-6rem] 2xl:mt-[-9rem] ml-[-3rem] sm:ml-[15rem] md:ml-[22rem] lg:ml-[30rem] xl:ml-[41rem] 2xl:ml-[42rem]">
          MY PROJECTS
        </div>
        <div className="mt-[-3rem] sm:mt-[-5rem] md:mt-[-6rem] lg:mt-[-7rem] xl:mt-[-5rem] 2xl:mt-[-10rem] ml-[-11rem] sm:ml-[-6rem] md:ml-[-6rem] lg:ml-[3rem] xl:ml-[9rem] 2xl:ml-[12rem] w-[30rem] sm:w-[50rem] md:w-[60rem] lg:w-[70rem] xl:w-[75rem] 2xl:w-[80rem] h-[15rem] sm:h-[25rem] md:h-[30rem] lg:h-[35rem] xl:h-[40rem] 2xl:h-[50rem] scale-[0.6] sm:scale-[0.60] md:scale-[0.5] lg:scale-[0.60] xl:scale-[0.8] 2xl:scale-[0.4]">
          <Carousel items={items} />
        </div>

        <div className="mt-[-5rem] sm:mt-[-24rem] md:mt-[-30rem] lg:mt-[-40rem] xl:mt-[-48rem] 2xl:mt-[-64rem] ml-[-16rem] sm:ml-[-23rem] md:ml-[-27rem] lg:ml-[-29rem] xl:ml-[-30rem] 2xl:ml-[-30rem] w-[30rem] sm:w-[50rem] md:w-[60rem] lg:w-[70rem] xl:w-[75rem] 2xl:w-[80rem] h-[15rem] sm:h-[25rem] md:h-[30rem] lg:h-[35rem] xl:h-[40rem] 2xl:h-[50rem] scale-[0.2] sm:scale-[0.25] md:scale-[0.35] lg:scale-[0.45] xl:scale-[0.6] 2xl:scale-[0.5]">
