...
export default function InfiniteScroll({
  ...
  return (
    <div
      className="relative flex items-center justify-center w-full overflow-hidden overscroll-none border-t-2 border-b-2 border-transparent"
      ref={wrapperRef}
      style={{ maxHeight }}
    >
      <div
      ...
      >
        {items.map((item, i) => (
          ...
          >
            ...
            item.content.match(/\.(wmv|mp4|webm|ogg)$/i) ? (
              <video
                src={item.content}
                controls
                autoPlay
